...
class Connect4Gui(QtWidgets.QMainWindow):
    ...
    def print_perception(self, perceived_value: float) -> None:
        ...
        print(f"{PrintColors.transparent}|{PrintColors.endc} {p2} ({PrintColors.red}red{PrintColors.endc})       win : {p2_color}{PrintColors.bold}{lp2w}{PrintColors.endc}% {PrintColors.transparent}|{PrintColors.endc}")
